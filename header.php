			...
			<div id="branding-inner">
				<div class="container">
					...
					<nav role="navigation" class="nav site-navigation main-navigation">
						<h1 class="assistive-text"><?php _e( 'Menu', 'wpfolio' ); ?></h1>
						<div class="assistive-text skip-link"><a href="#content" title="<?php esc_attr_e( 'Skip to content', 'wpfolio' ); ?>"><?php _e( 'Skip to content', 'wpfolio' ); ?></a></div>
