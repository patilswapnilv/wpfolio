...
<li id="post-<?php the_ID(); ?>" <?php post_class( 'wrap four columns' ); ?>>
	<div class="entry-link">
		<a href="<?php the_permalink(); ?>" title="<?php echo esc_attr( sprintf( __( 'Permalink to %s', 'wpfolio' ), the_title_attribute( 'echo=0' ) ) ); ?>" rel="bookmark"></a>
	</div><!-- .entry-link -->
	...
	<?php
		if ( '' != get_the_post_thumbnail () ) {
			...
			if ( $images ) {
				...
				$image = wp_get_attachment_image_src( $image->ID, 'wpfolio-featured-thumbnail' );
